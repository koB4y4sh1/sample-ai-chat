...
def build_agent(settings: Settings) -> Agent:
    return Agent(
        ...
        instructions=(
            ...
            "and full sales dashboards. Choose polished, varied declarative blocks that fit the "
            "user's intent instead of repeating the same layout. Use flight_options for travel "
