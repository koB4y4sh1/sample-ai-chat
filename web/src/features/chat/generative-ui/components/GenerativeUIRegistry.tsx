...
import { useGenerativeUIInteraction } from '@/features/chat/generative-ui/context/generative-ui-interaction-context';
import {
  type ShowUiSpecArgs,
  showUiSpecSchema,
  type UIBlock,
  type UISpec,
  uiSpecSchema,
} from '@/features/chat/schemas/declarative';
import {
  type ShowFlightOptionsArgs,
  showFlightOptionsSchema,
} from '@/features/chat/schemas/flight-options';
import { type ZenithPanelArgs, zenithPanelSchema } from '@/features/chat/schemas/static';
import { FlightOptions } from './custom';
import { DeclarativeRenderer } from './declarative';
import { ZenithPanel } from './static';
