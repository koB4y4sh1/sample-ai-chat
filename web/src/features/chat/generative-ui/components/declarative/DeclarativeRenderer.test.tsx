...
import type { UISpec } from '@/features/chat/schemas/declarative';
...
describe('DeclarativeRenderer chat-business blocks', () => {
  it('renders chat workflow blocks without requiring interactive handlers', () => {
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'Registry',
              path: 'web/src/features/chat/generative-ui/components/GenerativeUIRegistry.tsx',
              line: '887',
            },
          ],
        },
    ...
    expect(
      screen.getByText(
        'web/src/features/chat/generative-ui/components/GenerativeUIRegistry.tsx:887',
      ),
    ).toBeInTheDocument();
